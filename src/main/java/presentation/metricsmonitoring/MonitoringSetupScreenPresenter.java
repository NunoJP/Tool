...
public class MonitoringSetupScreenPresenter implements IViewPresenter {
    ...
    public MonitoringSetupScreenPresenter(JFrame motherFrame) {
        view = new MonitoringSetupScreen(motherFrame);
    ...
    private void defineViewBehavior() {
        ...
        startButton.addActionListener(
                e -> {
                    ...
                    var metricsScreenPresenter = new MetricsMonitoringScreenPresenter(
