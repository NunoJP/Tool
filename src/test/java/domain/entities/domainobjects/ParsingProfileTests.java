...
public class ParsingProfileTests {
    ...
    public void addPortionAndGetProfile() {
        ...
        parsingProfile.addPortion(new ParsingProfilePortion(TextClassesEnum.DATE.getName(), true, false, false));
        parsingProfile.addPortion(new ParsingProfilePortion(SeparatorEnum.SPACE.getName(), false, true, false));
        parsingProfile.addPortion(new ParsingProfilePortion(TextClassesEnum.TIMESTAMP.getName(), false, false, false));
    ...
    public void addSpecificFormatPortionAndGetProfile() {
        ParsingProfile parsingProfile = new ParsingProfile();
        parsingProfile.addPortion(new ParsingProfilePortion(TextClassesEnum.DATE.getName(), false, false, true, "YYYY-MM-DD"));
        parsingProfile.addPortion(new ParsingProfilePortion(SeparatorEnum.SPACE.getName(), false, true, false));
        parsingProfile.addPortion(new ParsingProfilePortion(TextClassesEnum.TIMESTAMP.getName(), false, false, true, "HH-mm-ss"));
        ArrayList<ParsingProfilePortion> portions = parsingProfile.getPortions();
        assertEquals(3, portions.size());
